        ...
        <section className="pacchetti-section" id="pacchetti">
            <div className="container">
                <div className="row gy-4 pacchetti">
                    <div className="pacchetto-grid mt-5">
                    ...
                    <div className="pacchetto-grid mt-0 mt-md-5">
                    ...
                    <div className="pacchetto-grid mt-0 mt-md-5">
                        <div className="text-and-button-grid">
                            ...
                            <div className="text-center mt-3 mb-3 mb-md-0">
                                <a className="btn btn-hero" href="https://wa.me/3925372152" target="_blank" rel="noopener noreferrer">Scopri di più</a>
                            </div>
                        </div>
                        <div className="immagine-grid">
                            <img className="img-pacchetto img-fluid rounded" src="/img/immagine-pacchetto-sposa.jpg" alt="Pacchetto Cerimonia" />
                        </div>
                    </div>
                    ...
                    <div className="pacchetto-grid mt-0 mt-md-5">
                        ...
                        <div className="immagine-grid item-2">
                            <img className="img-pacchetto img-fluid rounded" src="/img/immagine-pacchetto-schiariture.png" alt="Pacchetto Stiratura alla Cheratina" />
                        </div>
                    </div>
                </div>
            </div>
